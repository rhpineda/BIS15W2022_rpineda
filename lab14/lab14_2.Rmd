...
# Make the plot:
ggVennDiagram(swim_carni_aqua_ecto_list, category.names = c("Swimming", "Carnivore", "Aquatic", "Ectotherm"))
```
...
```{r}
rept_count_homerange <- homerange %>%
