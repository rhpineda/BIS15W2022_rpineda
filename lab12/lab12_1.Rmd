...
#spider_joined_left <- left_join(spiders_all, spiders_locs, by="Accession")
#spider_joined_right <- right_join(spiders_all, spiders_locs, by="Accession")
```
