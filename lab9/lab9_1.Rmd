...
tibble(homerange)
```
Yes, the data is tidy and it has NAs.
...
log10.hra and log10.preymass are directly related so as one variable increases, the other does as well.

I dont think that the NAs are plotted.
