...
The R program executes code while RStudio includes a GUI for R which makes it easier to use. GitHub is useful to programmers because it allows for the collaboration
and sharing of code.
