...
R is a scripting program while RStudio is a GUI for R which makes it easier to use. R is required for RStudio to work. GitHub is useful to programmers because it allows for the collaboration and sharing of code.
